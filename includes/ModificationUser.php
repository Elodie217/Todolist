...
<div class=" absolute top-0 bg-white w-screen h-screen z-20">
    ...
    <button class="supprimerUser absolute top-28 right-52 p-2 bg-red-200 border-2 border-red-500 rounded-2xl py-2 text-center">Supprimer le compte</button>
    ...
    <div class="flex min-h-full flex-col justify-center px-6  lg:px-8 ">
        ...
        <div class="mt-2 sm:mx-auto sm:w-full sm:max-w-sm">
            <div class="space-y-6">
                ...
                <div>
                    <button type="submit" class="boutonModification flex w-full justify-center rounded-md bg-[#FC8C78] hover:bg-[#FFB59F] px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 text-red-700">Modifier</button>
                </div>
            </div>
        </div>
    </div>
